...
<template>
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel for="email" value="Birthay" />
                <TextInput
                    id="email"
                    type="date"
                    class="mt-1 block w-full"
            ...
            <div class="mt-4">
                <InputLabel for="email" value="Addresse" />
                <TextInput
                    type="text"
                    class="mt-1 block w-full"
                    required
            ...
            <div class="flex flex-col items-center justify-end mt-4">
                ...
                <p class="text-sm text-gray-600 mt-6">
                    ...
                    <Link
                        :href="route('login')"
                        class="underline mt-6 text-indigo-600 hover:text-indigo-600 dark:hover:text-indigo-300"
                    >
                        Login
                    </Link>
                </p>
